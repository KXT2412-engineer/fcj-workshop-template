...
The "Fail Fast, Learn Fast" spirit is very clearly demonstrated. People are not afraid to share their mistakes (like misconfiguring environments or Database connection errors) so we can all learn together. Despite working at a fairly high intensity during the sprint phase of the Snaptics project, the team maintained cohesion and supported each other with cross code reviews.
...
- What are you **most satisfied** with during the internship?  
  What I am most proud of and satisfied with is the mindset shift. From someone who was only used to writing code running on a local machine, I now know how to methodically design Backend architectures, handle complex data flows, and confidently deploy C#/.NET 10 APIs for the Snaptics project to a production environment.
...
- Do you have any proposals to improve the internship experience?  
  It would be great if the program included "Mock Interview" sessions at the end of the term, based on the very features or APIs of the projects we just built (like Snaptics). This helps interns learn how to present their systems thinking and prepare themselves mentally as they enter the job market.
