...
|---|---|---|---|---|
| Monday | - **Snaptic - Database Migration:** <br>&emsp; + Fix budget and transaction entities <br>&emsp; + Add DB migrations to update the environment | 06/07/2026 | 06/07/2026 | Snaptic Git |
...
| Wednesday | - **DevOps Practice:** <br>&emsp; + Write basic Dockerfile <br>&emsp; + Configure and build optimized Image for .NET Core | 08/07/2026 | 08/07/2026 | Internal documents |
| Thursday | - **Snaptic - Authorization:** <br>&emsp; + Add Dockerfile to Repository <br>&emsp; + Add `[Authorize]` for multiple controllers | 09/07/2026 | 09/07/2026 | Snaptic Git |
| Friday | - **Snaptic - Optimization & Exception:** <br>&emsp; + Upgrade budget management by user <br>&emsp; + Improve transaction details, handle global exceptions | 10/07/2026 | 10/07/2026 | Snaptic Git |
