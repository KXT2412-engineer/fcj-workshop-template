...
|---|---|---|---|---|
| Monday | - **Snaptic - AI & Entities:** <br>&emsp; + Add Budget, Notification entities <br>&emsp; + Configure AI service for image analysis and invoice reading | 08/06/2026 | 08/06/2026 |  |
| Tuesday | - **Snaptic - Auto-Transaction:** <br>&emsp; + Write logic to create transactions from bills returned by AI <br>&emsp; + Expand AI service to create/manage categories | 09/06/2026 | 09/06/2026 |  |
| Wednesday | - **Snaptic - Refactor:** <br>&emsp; + Update TransactionService <br>&emsp; + Optimize the Transaction processing flow | 10/06/2026 | 10/06/2026 |  |
| Thursday | - **Snaptic - Review Flow:** <br>&emsp; + Add need-review API <br>&emsp; + Update item inventory review flow | 11/06/2026 | 11/06/2026 |  |
| Friday | - **Snaptic - Algorithm & Job:** <br>&emsp; + Add missing-prices, Levenshtein logic for item matching <br>&emsp; + Add background job for scan notification using Hangfire | 12/06/2026 | 12/06/2026 |  |
