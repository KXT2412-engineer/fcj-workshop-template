...
| Wednesday | - **Snaptic - AWS S3 Integration:** <br>&emsp; + Add measurement units <br>&emsp; + Install S3 SDK and generate Pre-signed URLs structure | 17/06/2026 | 17/06/2026 | Snaptic Git |
| Thursday | - **Snaptic - Data Security:** <br>&emsp; + Change data model from `ImageUrl` to `ImageKey` <br>&emsp; + Update budget, admin, notification enums | 18/06/2026 | 18/06/2026 | Snaptic Git |
| Friday | - **Snaptic - Upload & S3 API:** <br>&emsp; + Refactor image upload (AiController, TransactionController) <br>&emsp; + Add API to securely fetch images from S3 in S3Controller | 19/06/2026 | 19/06/2026 | Snaptic Git |
