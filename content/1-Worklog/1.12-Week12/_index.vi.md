...
- **AWS:** Triển khai sản phẩm cuối cùng (Production Deployment) lên AWS Elastic Beanstalk.
- **Dự án Snaptic:** Viết tài liệu đặc tả (SRS), kiểm thử toàn diện, và hoàn thành báo cáo tổng kết thực tập.
...
- Đưa thành công ứng dụng .NET Backend lên môi trường Production thực tế trên AWS.
- Hệ thống đáp ứng đầy đủ yêu cầu nghiệp vụ và tuân thủ chuẩn quy định Hóa đơn điện tử của Nhà nước.
- Hoàn thành xuất sắc chặng đường 12 tuần thực tập với kiến trúc Cloud & Backend toàn diện.
