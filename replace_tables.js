...
// Replace tables in _index.vi.md for each week
...
for (let i = 1; i <= 12; i++) {
    ...
    const filePath = path.join(folderPath, '_index.vi.md');
    ...
    if (fs.existsSync(filePath)) {
        ...
        console.log('Updated Week ' + i + ' _index.vi.md');
    }
}
